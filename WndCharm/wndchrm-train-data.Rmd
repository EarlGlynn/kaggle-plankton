...
```{r}
scaledTrain <- scale(feature.matrix[, -1])  # exclude class
dim(scaledTrain)
...
```{r}
save(scaledTrain, svdTrain, file="plankton-train-wndchrm-svd.Rdata")
```

For now, let's look at first 75 eigenvalues ...
```{r}
Neigen <- 75
```
